...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <span>1. Сколько цветов в радуге? </span>
            <div class="checkbox">
                <label><input type="checkbox" value="1">2</label>
            </div>
            <div class="checkbox">
                <label><input type="checkbox" value="2">4</label>
            </div>
            <div class="checkbox disabled">
                <label><input type="checkbox" value="3">14</label>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <span>2. Сколько дней в году?</span>
            <input type="text">
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <span>3. Кто проживает на дне океана?</span>
            <select>
